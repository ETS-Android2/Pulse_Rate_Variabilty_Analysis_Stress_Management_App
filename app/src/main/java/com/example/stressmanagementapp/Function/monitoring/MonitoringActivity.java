...
public class MonitoringActivity extends AppCompatActivity {
    private Timer timer;
    private String apiPath,targetID,pairCode;
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (latestMeasuredResult.get("userID").toString().equals(targetID)) {
...
//                            measuredResultStringList.clear();
                            try {
                                if(response.getString("error").equals("invalid relationship")) {
